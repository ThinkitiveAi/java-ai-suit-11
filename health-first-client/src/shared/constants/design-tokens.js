// Healthcare-focused design tokens for consistent styling
export const COLORS = {
  // Primary healthcare blue - trustworthy and professional
  primary: {
    50: '#f0f9ff',
    100: '#e0f2fe',
    200: '#bae6fd',
  ...
  // Healthcare green - health and wellness
  health: {
    50: '#f0fdf4',
    100: '#dcfce7',
    200: '#bbf7d0',
  ...
  // Medical blue - calm and trustworthy
  medical: {
    50: '#eff6ff',
    100: '#dbeafe',
    200: '#bfdbfe',
...
export const HEALTHCARE = {
  ...
  buttonVariants: {
    ...
    success: {
      bg: COLORS.health[600],
      hover: COLORS.health[700],
      focus: COLORS.health[500],
      text: COLORS.white,
    },
    outline: {
      bg: 'transparent',
